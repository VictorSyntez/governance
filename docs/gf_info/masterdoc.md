...
The purpose of the Canadian Credential Network is to administer decentralized governance for Bedrock Business Utility.
...
2. The Canadian Credential Network MUST publish a Bedrock Trust Mark Policies​ ​as a Controlled Document managed as specified by BBU Governing Bodies.​
...
2. BBU Governance Bodies MUST specify the Canadian Credential Network Governing Body for each Controlled Document.
